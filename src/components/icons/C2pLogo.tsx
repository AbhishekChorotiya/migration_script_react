...
const C2pLogo = (props: Props) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        xmlnsXlink="http://www.w3.org/1999/xlink"
        aria-labelledby="paymentIconTitle paymentIconDesc"
        className="src-icon"
        viewBox="0 0 29 18"
        {...props}
    >
        <defs>
            <path id="a" d="M0 0h27.985v17.897H0z" />
        </defs>
